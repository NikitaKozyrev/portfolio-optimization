...
```{r}
portfolio_weights_comparison_6_period <- matrix(0,nrow=4,ncol=10)*100
...
portfolio_weights_comparison_6_period[4,] <- rep(0.1,10)*100
...
rownames(portfolio_weights_comparison_6_period) <- c("Sharpe", "Sortino", "Sharpe normal benchmark", "equally weighted")
```

```{r}
portfolio_weights_comparison_3_period <- matrix(0,nrow=4,ncol=10)*100
...
portfolio_weights_comparison_3_period[4,] <- rep(0.1,10)*100
...
rownames(portfolio_weights_comparison_3_period) <- c("Sharpe", "Sortino", "Sharpe normal benchmark", "equally weighted")
write.xlsx(portfolio_weights_comparison_3_period, paste("weights_3period", ".xlsx"))
```

```{r}
portfolio_weights_comparison_5_period <- matrix(0,nrow=4,ncol=10)*100
...
portfolio_weights_comparison_5_period[4,] <- rep(0.1,10)*100
...
rownames(portfolio_weights_comparison_5_period) <- c("Sharpe", "Sortino", "Sharpe normal benchmark", "equally weighted")
```

```{r}
portfolio_weights_comparison_12_period <- matrix(0,nrow=4,ncol=10)*100
...
portfolio_weights_comparison_12_period[4,] <- rep(0.1,10)*100
...
rownames(portfolio_weights_comparison_12_period) <- c("Sharpe", "Sortino", "Sharpe normal benchmark", "equally weighted")
```

```{r}
portfolio_weights_comparison_11_period <- matrix(0,nrow=4,ncol=10)*100
...
portfolio_weights_comparison_11_period[4,] <- rep(0.1,10)*100
...
rownames(portfolio_weights_comparison_11_period) <- c("Sharpe", "Sortino", "Sharpe normal benchmark", "equally weighted")
```
